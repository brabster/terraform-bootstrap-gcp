...
If you are building in an environment with an intercepting proxy that is not automatically detected, you can manually provide the proxy's CA certificate:
